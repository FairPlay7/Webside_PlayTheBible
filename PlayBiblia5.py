...
def get_random_verse_api(verse_path):
    ...
    verse_mapping = {
        'wj/20/2-17': 'Wyjścia 20:2-17',
        'joz/1/9': 'Jozuego 1:9',
        'ne/8/10': 'Nehemiasza 8:10',
        'ps/1/1-2': 'Psalm 1:1-2',
        ...
        'lm/3/22-23': 'Lamentacje 3:22-23',
        'mi/6/8': 'Michasza 6:8',
        'mt/5/3-10': 'Mateusza 5:3-10',
